      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <Link
              href="/register"
              className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 rounded-lg transition-all"
            >
              Sign Up
            </Link>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center space-x-4">
            <Link
              href="/register"
              className="px-8 py-3 text-lg font-medium text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 rounded-lg shadow-md transition-all"
            >
              Get Started
            </Link>
            <Link
              href="/login"
              className="px-8 py-3 text-lg font-medium text-teal-600 bg-white hover:bg-gray-50 border border-teal-600 rounded-lg transition-colors"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <p className="text-lg font-semibold text-teal-600">Next.js 14</p>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-600">Backend</p>
              <p className="text-lg font-semibold text-teal-600">Node.js + Express</p>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-600">Database</p>
              <p className="text-lg font-semibold text-teal-600">PostgreSQL</p>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-600">Real-time</p>
              <p className="text-lg font-semibold text-teal-600">Socket.IO + Kafka</p>
            </div>
          </div>
        </div>
      </main>
